;(function() {
  ...
  AcontecimentosController.$inject = ['$scope', '$routeParams', '$firebase', 'FIREBASE_URI', '$cookies', 'ngDialog'];

  function AcontecimentosController($scope, $routeParams, $firebase, FIREBASE_URI, $cookies, ngDialog) {
                  ...
                  Acontecimentos: {
                    ...
                    3: {
                      ...
                      Respostas: [{
                          ...
                          DesdobramentoPositivo: {
                              DesdobramentoUrl: 'propinaaceita.png',
                              ContinuacaoId: 2,
                        ...
                        },
                        {
                          ...
                          DesdobramentoNegativo: {
                            DesdobramentoUrl: 'presocidadao.png',
                              ContinuacaoId: 0,
    ...
    $scope.RealizaAcao = function(Resposta){
      ...
      if($scope.Desdobramento.Artigo){
        var desdobr = $scope.Desdobramento;

        // Abre Dialog com Implicações de Crime
        ngDialog.open({
            template: 'CrimeDialog',
            controller: ['$scope',  function ($scope) {

              $scope.DesdobramentoDialog = angular.copy(desdobr);
